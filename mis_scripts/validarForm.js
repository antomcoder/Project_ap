function validar(){
   ...
   const comentario = document.getElementById("miText").value.trim();
   ...
   if(nombre === "" || correo === "" || celular === ""){
     ...
     return false
       ...
       Swal.fire({
         title:"<h2 class = 'title'> Coloca un comentario mas resumido! <h2>",    //tilte si se acepta codigo html
         //html:"RELLENAR TODOS LOS ESPACIOS",  //si se permite html
         icon:"warning",  //error   wargning  info  success
         confirmButtonText:"Aceptar",
         backdrop:true,    //el fondo se matiza oscuro con true y false 
         footer: '<h3 class = "footer"> Comentario </h3>',  //se puede utilizar html
         //width:"35%",    //ancho de ventana trabajar en %
         //timer: 5000,
         //timerProgressBar: true,
         padding: "10px",   //paddinn ventana
     ...
     console.log("Mensaje enciado con exito")
     return true
   }
}
